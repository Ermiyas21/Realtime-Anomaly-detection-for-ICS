...
def predict_and_detect(batch_df):
    ...
    print(f"Latency: {total_processing_time:.4f} seconds")  
...
#v spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.3.0 /sparkScripts/streamingProcess2LSTM.py
